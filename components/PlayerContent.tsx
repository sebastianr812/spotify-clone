    ...
    return (
        <div className="grid h-full grid-cols-2 md:grid-cols-3">
            ...
            <div className='hidden h-full md:flex justify-center items-center w-full max-w-[722px] gap-x-6'>
                <AiFillStepBackward size={30} className='transition cursor-pointer text-neutral-400 hover:text-white' onClick={onPlayPrevious} />
                <div onClick={() => { }} className='flex items-center justify-center w-10 h-10 p-1 bg-white rounded-full cursor-pointer'>
                    <Icon onClick={handlePlay} size={30} className='text-black' />
                </div>
                <AiFillStepForward size={30} onClick={onPlayNext} className='transition text-neutral-400 cusror-pointer hover:text-white' />
            </div>
